...
<h4>Gráfico interactivo: Pase el mouse sobre el gráfico y seleccione, en la parte de abajo, los países que quiera comparar. El ancho de cada color determina la proporción de ese país sonbre el total</h4>
<br>
```{r, include=T, echo = F}
...
<center><h4>Gráfico interactivo: Pase el mouse sobre el gráfico y seleccione, en la parte de abajo, los países que quiera comparar.El ancho de cada color determina la proporción de ese país sonbre el total</h4></center>
```{r, include=T, echo = F}
rio_confirmados
```
...
<br>
<br>
<center><h2>Nuevos casos de **fallecidos** por día desde fallecido '0' en cada país</h2></center>
<center><h4>Gráfico interactivo: Pase el mouse sobre el gráfico y seleccione, en la parte de abajo, los países que quiera comparar.El ancho de cada color determina la proporción de ese país sonbre el total</h4></center>
...
<br>
<br>
<center><h2>Fallecidos acomulados por día desde fallecido '0' en cada país</h2></center>
<center><h4>Gráfico interactivo: Pase el mouse sobre el gráfico y seleccione, en la parte de abajo, los países que quiera comparar.El ancho de cada color determina la proporción de ese país sonbre el total</h4></center>
```{r, include=T, echo = F}
rio_fallecidos
```
...
<center><h4>Nuevos casos confirmados confirmados por semana</h4></center>
...
<br>
<br>
<center><h2>Nuevos casos fallecidos confirmados por semana</h2></center>
```{r, include=T, echo = F,  fig.height = 21, fig.width = 20}
curva_fallecidos
```
<br>
...
<h1>Tablas</h1>
<br>
Aquí encontrará los datos con los indicadores antes descritos pero en formato de tabla 188 países del mundo
<br>
